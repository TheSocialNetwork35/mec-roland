...
export function SiteFooter({ content }: { content: SiteContent }) {
  ...
  return <footer className="footer">
    <div className="shell footer__main">
      <Link className="brand brand--footer" href="/"><img src={global.logo} alt={global.restaurantName} width="425" height="215" data-cms-image="global.logo" data-cms-label="Logo" /></Link>
