  ...
  return {
    ...
    plugins: [
      ...
      cloudflare({
        ...
        // During a build the production entry in `dist/` does not exist yet.
        // Vinext provides this virtual development entry and writes the real
        // Worker entry to `dist/server/index.js`.
